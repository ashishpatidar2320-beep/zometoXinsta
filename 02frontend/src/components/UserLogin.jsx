...
const UserLogin = () => {
    ...
    async function handleSubmit(e) {
        e.preventDefault()
        try{
            const responce = await axios.post("http://localhost:4000/auth/user/login",{
            email,
            password,
        },{
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-6 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-6 sm:p-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">User — Sign in</h1>
        ...
        className="space-y-5">
          ...
          >
            Are you a food partner? <a href="#" className="text-indigo-600 hover:underline">Sign in</a>
          </p>
        </form>
      </div>
    </div>
